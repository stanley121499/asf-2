 ...
 *
 * Place this provider inside `<AuthProvider>` in the root layout so that
 * every page in the app has access to `useFeatureFlags()`.
 */
export function FeatureFlagsProvider({
  ...
  useEffect(() => {
    ...
    // within seconds without a page reload.
