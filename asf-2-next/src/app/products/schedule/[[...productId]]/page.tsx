                      ...
                      .map((product) => (
                        <div
                          ...
                          <div className="flex items-center gap-4">
                            <ListThumbnail
                              rawUrl={productMedias.find((media) => media.product_id === product.id)?.media_url}
                              name={product.name}
                            />
...
export default function WrappedScheduleProductListPage(props: any) {
  return (
    <ProductContextBundle>
      <ScheduleProductListPage {...props} />
    </ProductContextBundle>
  );
}
