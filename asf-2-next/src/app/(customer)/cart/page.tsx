            ...
            <Card className="mb-6">
              <div className="text-center py-10">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Link href="/authentication/sign-in?returnTo=%2Fcart">
    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="mb-6">
            <Link href="/product-section" className="inline-flex items-center text-blue-600 hover:underline">
                      ...
                      <div key={item.id} className="flex flex-col md:flex-row border-b border-gray-200 dark:border-gray-700 pb-4 last:border-0 last:pb-0">
                        ...
                        <div className="flex-grow md:ml-4">
                          <div className="flex flex-col md:flex-row justify-between">
                            <div>
                              <Link href={`/product-details/${item.productId}`} className="text-lg font-medium text-gray-900 dark:text-white hover:text-blue-600">
                                {item.name}
                              </Link>
                              {item.isDeleted && (
